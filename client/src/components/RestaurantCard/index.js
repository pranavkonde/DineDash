  ...
  return (
    <div className='Restaurant'>
      ...
      <div className='contentDiv'>
        <h4 style={{ fontSize:'20px',textDecoration:'bold' }}>
        {name}            
        </h4>
